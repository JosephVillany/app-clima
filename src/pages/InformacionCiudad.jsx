...
// importo los iconos para su llamado en la info de ciudad 
...
const InformacionCiudad = () => {
    ...
    const url = `https://api.openweathermap.org/data/2.5/weather?q=${ciudad}&appid=f4d2c2ca4396e4ff4033c5632dafd446`
    const {data}= useUrl(url)
    console.log(data);
    ...
    return (
        ...
        <div className="bg-gradient-to-t from-purple-100 via-pink-200 to-red-300 flex justify-center">
        <div  className=" flex-col max-w-sm mx-auto  w-96 bg-gradient-to-t from-purple-400 via-pink-500 to-red-500 min-h-screen">
